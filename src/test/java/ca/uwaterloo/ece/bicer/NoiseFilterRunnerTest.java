...
public class NoiseFilterRunnerTest {
    @Test public void testSomeLibraryMethod() {
    	...
    	String [] args ={"-d",System.getProperty("user.home") + "/Documents/ODP/projects/lucene/biChangesBICER.txt", "-g",
    				System.getProperty("user.home") + "/Documents/ODP/projects/lucene/git"};
