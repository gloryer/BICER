...
public class ArffMergerTest {
    @Test public void testSomeLibraryMethod() {
		...
		for(int patchSize:patchSizes){
			...
			for(String dirName: dirNames){
		    	...
		    	Instances newTrainingInstances = new Instances(Utils.loadArff(dataPath + "0/train.arff", classAttributeName),0);
		    	Instances newTestInstances = new Instances(Utils.loadArff(dataPath + "0/test.arff", classAttributeName),0);
		    	
		    	System.out.println("newTrainingInstances.numAttributes(): " + newTrainingInstances.numAttributes());
		    	
		    	Attribute newDateAttribute = new Attribute(dateAttributeName);
		    	Attribute newPathAttribute = new Attribute(pathAttributeName);
		    	...
		    	for(int i=0; i<numDataFolds;i++){
		    		...
		    		// for training
		    		getNewInstances(startDateForTraining, endDateForTraining, dateAttributeName, changeIDsForTraining,
							newTrainingInstances, instances);
		    		getNewInstances(startDateForTraining, endDateForTraining, dateAttributeName, changeIDsForTraining,
							newTrainingInstances, instances2);
		    		
		    		// for test
		    		getNewInstances(startDateForTest, endDateForTest, dateAttributeName, changeIDsForTest,
	...
	private void getNewInstances(String startDate, String endDate, String dateAttributeName,
			ArrayList<String> changeIDs, Instances newInstances, Instances instances) {
		
		for(Instance instance:instances){
			String strDate = instance.stringValue(instances.attribute(dateAttributeName));
